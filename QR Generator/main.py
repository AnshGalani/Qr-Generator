...
class Qr_Generator:
    def __init__(self,root):
        self.root=root
        self.root.geometry("900x500+350+100")
        self.root.title("QR Generator | Developed By Ansh")
        ...
        emp_title=Label(emp_Frame,text="Employee Detalis",font=("goudy old style",20),bg="#043265",fg="white").place(x=0,y=0,relwidth=1)
        ...
        btn_generate=Button(emp_Frame,text="Qr Generate",command=self.generate,font=("times new roman",18,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=30,y=250,width=180,height=30)
        btn_clear=Button(emp_Frame,text="Clear",command=self.clear,font=("times new roman",18,"bold"),bg="#607d8b",fg="white",cursor="hand2").place(x=225,y=250,width=120,height=30)
        btn_exit=Button(emp_Frame,text="Exit",command=self.exit,font=("times new roman",18,"bold"),bg="red",fg="white",cursor="hand2").place(x=360,y=250,width=120,height=30)
        ...
        qr_title=Label(qr_Frame,text="Employee QR Code",font=("goudy old style",20),bg="#043265",fg="white").place(x=0,y=0,relwidth=1)
    ...
    def generate(self):
        if self.var_designation.get()=="" or self.var_emp_code.get()=="" or self.var_department.get()=="" or self.var_name.get()=="":
            ...
            qr_code.save("QR pic/EMP_"+str(self.var_emp_code.get()+".png"))
            
            #======QR Code Image Update=====
            
            self.im=ImageTk.PhotoImage(file="QR pic/EMP_"+str(self.var_emp_code.get()+".png"))
